    ...
    mainContent = (
      <div>
        <div className="container calender-image">
            ...
            <img src="https://i.gifer.com/7b5j.gif" className="image-title-calender"/>
            <p className="mr-auto calender-title-text">Calender Of <br/> Astronomical Events</p>
            </div>
            <div className="row">
                ...
                {data.map((object) => {
                  return (
                    <tr>
                      ...
                      <td> 
                      <a href="#" className="nameOfObject" onClick={() => setSelectObjectData(object)}>
